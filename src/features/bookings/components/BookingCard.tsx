	...
	return (
		<div className="flex flex-col border border-primary-800 md:flex-row">
			...
			<div className="flex flex-col lg:flex-row">
				...
				<div className="flex h-10 items-center justify-between border-t border-primary-800 lg:h-0 lg:w-[100px] lg:flex-col lg:justify-normal lg:border-l lg:border-t-0">
					<Link
						href={`/account/reservations/edit/${id}`}
						className="group flex flex-grow items-center justify-center gap-2 border-r border-primary-800 py-3 text-xs font-bold uppercase text-primary-300 transition-colors hover:bg-accent-600 hover:text-primary-900 lg:items-start lg:border-b lg:border-r-0"
					>
